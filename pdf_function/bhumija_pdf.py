...
def generate_acknowledgement_pdf(data: dict) -> bytes:
    ...
    payment_data = [
        ...
        create_data_row("DD DATE", data['dd_date_or_transaction_date']),
        create_data_row("DD NUMBER", data['dd_id_or_transaction_id']),
        create_data_row("DD AMOUNT", f"Rs. {data['dd_amount_or_transaction_amount']:,.2f}"),
